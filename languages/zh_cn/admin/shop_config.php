...
$_LANG['cfg_name']['integral_name'] = '云豆名称';
// $_LANG['cfg_name']['integral_scale'] = '云豆换算比例';
// $_LANG['cfg_name']['integral_percent'] = '云豆支付比例';
...
$_LANG['cfg_desc']['integral_name'] = '您可以将云豆重新命名。例如：烧币';
$_LANG['cfg_desc']['integral_scale'] = '每100云豆可抵多少元现金';
$_LANG['cfg_desc']['integral_percent'] = '每100元商品最多可以使用多少元云豆';
...
$_LANG['cfg_desc']['user_notice'] = '该信息将在首页页面显示';

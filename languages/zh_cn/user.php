...
$_LANG['to_pay_points'] = '恭喜您， 你%s论坛%s兑换了%s的商城云豆';
$_LANG['to_rank_points'] = '恭喜您， 你%s论坛%s兑换了%s的商城等级积分';
$_LANG['from_pay_points'] = '恭喜您， 你%s的商城云豆兑换%s论坛%s';
$_LANG['from_rank_points'] = '恭喜您， 你%s论坛%s兑换了%s的商城云豆';

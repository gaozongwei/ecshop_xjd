...
$_LANG['notice_integral'] ='兑换本商品需要消耗的云豆值';
...
$_LANG['exchange_integral_invalid'] = '云豆值为空或不是数字';

/*JS 语言项*/
$_LANG['js_languages']['no_goods_id'] = '没有选择商品';
$_LANG['js_languages']['invalid_exchange_integral'] = '云豆值为空或不是数字';
?>